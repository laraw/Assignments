...
Description:  Videos are a type of holding within the library. Videos can be borrowed by library members but have
a variable standard loan fee and a shorter maximum loan period. 
**/
...
public class Video extends AbstractHolding {
	...
	public double calculateLateFee() {	
		...
		// If the number of lapsed days is less than the max loan period, there is no late fee.
		// However, if the number of days exceeds the max loan period, the late fee is calculated based on
		// the number of days late by the surcharge
