...
Description: Premium members have a higher initial maximum credit and can return holdings even when they do not have
sufficient credit to pay a late fee. 
...
public class PremiumMember extends AbstractMember {
	...
	// When a holding is returned, the holding is added to the members history record and the member pays the late fee
