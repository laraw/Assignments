...
Description:  Books are a type of holding within the library. Videos can be borrowed by library members and have a 
fixed standard loan fee. 
**/
...
public class Book extends AbstractHolding {
	...
	// For a book, the max loan period, standard loan fee and late fee are values that do not change
	...
	public double calculateLateFee() {
		...
		// If the number of elapsed days is less than the loan period, there will be no late fee,
		// if the book is late, the loan fee is calculated based on the number of days late by the late fee
