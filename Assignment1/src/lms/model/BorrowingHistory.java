...
public class BorrowingHistory {
	...
	/** To determine the total late fees a member has paid, first get the standard loan fee for a holding and subtract from
		 the total fees paid**/
	...
	public int calculateTotalLateFees() {
		...
		// Get all the history records and calculate the total fee paid, then subtract the default loan fee to determine the
	...
	public HistoryRecord getHistoryRecord(int holdingId) {	
		...
		// Search for a specified holding in the members history records based on the Holding ID 
		for (int i = 0; i < records.size(); i++) {
